...
<jsp:include page="product/navba.jsp"></jsp:include>
...
<%--                                        <a href="/products?action=delete&id=${product.id}"><i class="fa fa-trash-fill">Xóa</i></a>--%>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            ...
                            <c:forEach begin="1" end="${endP}" var="i">
                                <li class="page-item active"><a class="page-link" href="menu?index=${i}">${i}</a></li>
                            </c:forEach>
                            <li class="page-item">
            ...
            <jsp:include page="product/sidebar.jsp"></jsp:include>
...
<jsp:include page="product/footer.jsp"></jsp:include>
